...
public class BSTDictionary {
    ...
    public void dictionaryInsert(int key, String value) {
        ...
        if(prev.key>key){
            prev.left = new DictionaryNode(key,value);
        } else {
            prev.right = new DictionaryNode(key,value);
        }
    }

    // You likely will want to use this recursive method:
//    public static DictionaryNode dictionaryInsertRec(int key, String value, DictionaryNode current) {
//        // YOUR CODE HERE
//        return null;
//    }
...
//    }
    ...
    // You likely will want to use this recursive method:
//    private static String dictionaryGetRec(int key, DictionaryNode current) {
//        // YOUR CODE HERE
//        return null;
//    }
    ...
    private static DictionaryNode dictionaryRemoveRec(int key, DictionaryNode current) {
        if (current == null){
            ...
            if (current.left==null&&current.right==null){
                ...
                int num = minValue(current.right);
                current.key = num;
                current.right = dictionaryRemoveRec(num, current.right);
            } else {
