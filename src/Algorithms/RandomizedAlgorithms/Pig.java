...
public class Pig {
    ...
    public static int playMatch(int player1Start, int player2Start, int player1Target, int player2Target) {
    ...
    public static int[] playSet(int player1Start, int player2Start, int player1Target, int player2Target) {
        int trials = 10000;
        int[] player1Scores = new int[3];
        for (int i = 0; i < trials; i++){
            int score = playMatch(player1Start, player2Start, player1Target, player2Target);
            if (score > 0) {
                player1Scores[0]++;
            } else if (score == 0) {
                player1Scores[2]++;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 61; i++){
            ...
            printSet(playSet(70, 90, i, 19));
        }
        System.out.println("\n\nLab Report Tests 75 and 40");
        for(int i = 1; i < 31; i++){
            System.out.println("Target = " + i);
            printSet(playSet(75, 40, i, 19));
        }
        System.out.println("\n\nLab Report Tests 75 and 40");
        for(int i = 1; i < 121; i++){
            System.out.println("Target = " + i);
            printSet(playSet(0, 90, i, 19));
        }
    }
}
